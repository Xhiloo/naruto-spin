...
async function fetchBackstory(results) {
  ...
  "anthropic-dangerous-direct-browser-access": "true",
    ...
    body: JSON.stringify({
      ...
      messages: [{
        role: "user",
        content: `You are a master Naruto lore writer. Write a dark, immersive shinobi backstory (190–220 words) for a character with these stats:\n\n${summary}\n\nFormat it like a Naruto databook entry. Include:\n- Their village origin and clan environment growing up\n- One defining childhood trauma or event that shaped them\n- How they discovered or developed their clan ability\n- Their fighting philosophy and what they fight for\n- End with ONE ominous prophecy-like sentence about their future\n\nMake it feel completely grounded in the Naruto universe. Be specific with places, events, and emotions. No generic phrases like "born a warrior" or "trained hard". Make this character feel REAL.`
      }]
    })
  });
